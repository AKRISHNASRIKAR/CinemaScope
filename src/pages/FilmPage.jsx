...
// Styled components for cast section
  ...
  useEffect(() => {
    const fetchFilmData = async () => {
      try {
        ...
        // Fetch certification (for example, US certification)
        const certResponse = await axios.get(
          `${BASE_URL}movie/${id}/release_dates?api_key=${apikey}`
        );
        ...
        const creditsResponse = await axios.get(
          `${BASE_URL}movie/${id}/credits?api_key=${apikey}`
        );
    ...
    <Container className="min-h-screen bg-[#121212]">
      ...
      <Details>
        ...
        <Rating>
          ...
          <Typography>{film.vote_average || "N/A"} / 10</Typography>
        </Rating>
